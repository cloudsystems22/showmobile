                    ...
                    <form name="planoRecorr" enctype="multipart/form-data" action="<?php $planoControle->contratar($planoId) ?>" method="post">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="btn-group justified-content">
                                    <label class="u-check">
                                        <input class="" name="tipoCliente" value='Pessoa Física' type="radio" id="PessoaFísica" checked>
                                        <span class="">Pessoa Física</span>
                                    </label>
                                    <label class="u-check">
                                        <input class="" name="tipoCliente" value='Pessoa Jurídica' type="radio" id="PessoaJurídica">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-12" id="divNumeroCell" style="">
                                ...
                                <div class="input-group">
                                    <input class="input-orange" type="file" name="pdfFile" id="pdfFile" accept=".pdf,.jpg" required />
                                </div>
